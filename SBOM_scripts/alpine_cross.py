...
if __name__ == "__main__":
    ...
    uses_bundled_libusb = "depmf_wrap_dict" not in depmf_wrap_dict
    ...
    for component, url in (
        ...
        (docker_login, "https://github.com/docker/login-action"),
        (docker_metadata, "https://github.com/docker/metadata-action"),
        (docker_bake, "https://github.com/docker/bake-action"),
    ):
